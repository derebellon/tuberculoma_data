...
## data
df_symptoms <- read_excel("data/Dataframe_tuberculoma.xlsx",
                 sheet = "symptoms",
                 na = "888")

df_clinical <- read_excel("data/Dataframe_tuberculoma.xlsx",
                          sheet = "clinical findings",
                          na = "888")

df_diagnosis <- read_excel("data/Dataframe_tuberculoma.xlsx",
                          sheet = "diagnosis",
                          na = "888")

df_treatment <- read_excel("data/Dataframe_tuberculoma.xlsx",
                          sheet = "treatment",
                          na = "888")
